...
if __name__ == "__main__":
    ...
    dem.WallInfo[0].point1 = ti.Vector([pos[0] + rad, 0., 0.])              # The vertex of the wall
    dem.WallInfo[0].point2 = ti.Vector([pos[0] + rad, 0.5, 0.])             # The vertex of the wall
    dem.WallInfo[0].point3 = ti.Vector([pos[0] + rad, 0.5, 10.])            # The vertex of the wall
    dem.WallInfo[0].point4 = ti.Vector([pos[0] + rad, 0., 10.])             # The vertex of the wall
    dem.WallInfo[0].norm = ti.Vector([-1, 0, 0])                            # The norm of the wall
    ...
    # MPM domain
    mpm = MPM.MPM(domain=ti.Vector([10, 0.5, 10.]),                         # domain size
                  ...
                  max_particle_num=1.6e6,                                  # The max number of particles
                  bodyNum=1,                                                # Taichi field of body parameters *Number of Body*
                  matNum=1,                                                 # Taichi field of material parameters *Number of Material*
    ...
    mpm.BodyInfo[0].Type = 1                                                # /Body shape/ 0 for rectangle; 1 for triangle; 2 for sphere
    ...
    mpm.BodyInfo[0].len = ti.Vector([10., 0.5, 10.])                       # Size of Body
    ...
    # STEP 2
    dem.wallList.WallDeactivated(wallID=0)
    dem.contModel.ForceLocalDamping[0] = 0
    TIME: float = 2.2                                                       # Total simulation time
