...
@ti.data_oriented
class DEMClump(DEMParticle.DEMParticle):
    def __init__(self, max_clump_num):
        self.clumpNum = ti.field(int, shape=[])
        self.max_clump_num = max_clump_num
        self.ID = ti.field(int, max_clump_num)      
        self.mass = ti.field(float, max_clump_num)
        self.center = ti.Vector.field(3, float, max_particle_num)
